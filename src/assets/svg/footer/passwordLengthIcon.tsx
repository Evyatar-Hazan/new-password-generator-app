  ...
  return (
    <TouchableOpacity style={{ marginHorizontal: 15 }} onPress={onPress}>
      <Svg width={48} height={48} viewBox="0 0 122.88 122.88" fill="none">
        ...
        <Line x1="25" y1="60" x2="90" y2="60" stroke={colors.text} strokeWidth="4" />
        ...
        <Circle cx="25" cy="60" r="2" fill={colors.text}  />
        <Circle cx="35" cy="60" r="2" fill={colors.text}  />
        <Circle cx="45" cy="60" r="2" fill={colors.text}  />
        <Circle cx="55" cy="60" r="2" fill={colors.text}  />
        <Circle cx="65" cy="60" r="2" fill={colors.text}  />
        <Circle cx="75" cy="60" r="2" fill={colors.text}  />
        <Circle cx="85" cy="60" r="2" fill={colors.text}  />
        <Circle cx="95" cy="60" r="2" fill={colors.text}  />
        <Circle cx="105" cy="60" r="2" fill={colors.text}  />

        {/* Range text below the slider */}
        <Text x="60" y="80" textAnchor="middle" fontSize="10" fill={colors.text} >1-20</Text>
